...
const resultTypes = {
  "世界図書館の魔法司書": {
    ...
    body: [
      ...
      "ただし、設定を作るのが楽しくなりすぎて、本編がなかなか始まらないこともあります。"
    ],
  ...
  "碧き竜の加護を受けた魔術士": {
    ...
    step: "派手な事件よりも、「ほんの少し心が軽くなる瞬間」を描いてみましょう。あなたの作品は、静かな一言で人の心に届きます。"
  },
  "忘れじの言葉を紡ぐ吟遊詩人": {
  ...
  "頂に至る白銀の魔術師": {
    ...
    body: [
      ...
      "SNS投稿、連載、Kindle、作品づくり、発信活動。続けるほどに強くなるタイプなので、仕組み化や予約投稿、テンプレ作りとも相性が良いです。"
    ],
    step: "まずは「週1回だけ投稿する」など、小さく続けられるルールを作りましょう。あなたの魔法は、継続した先で強くなります。"
  },
  "迷宮を形づくる案内人": {
  ...
  "漆黒の余白から帰還せし者": {
    ...
    step: "“何が起きたか”を全部説明するより、読者が想像できる余白を1つ残してみましょう。あなたの作品は、沈黙の中で強くなります。"
  },
  "赤銅（あかがね）と紺碧の錬金術師": {
    ...
    step: "最初から完成形を目指さず、「ラフ版」「修正版」「完成版」の3段階で作ってみましょう。あなたは磨くほど強くなるタイプです。"
  },
  "創造を歌う言霊士": {
    subtitle: "作品に言葉を添えて、外の世界へ届ける人",
    body: [
      "あなたは、言葉や発信を通して作品を届ける力があるタイプです。",
      "作品を作るだけで終わらせず、タイトル、紹介文、投稿文、キャッチコピーなどで、人に届く形へ変えていけます。",
      "あなたにとって言葉は、ただの説明ではなく、作品に命を吹き込むための道具です。",
      "漫画、SNS、Kindle、LP、告知文など、“届ける言葉”を磨くほど力が出ます。"
    ],
    step: "作品を作ったら、必ず「誰に」「どんな気持ちで読んでほしいか」を一文で書いてみましょう。その一文が、作品を外の世界へ連れていきます。"
  },
  "虹を繰り出す彩術士": {
    subtitle: "色と雰囲気で、人の目を惹きつける人",
    body: [
      "あなたは、色・雰囲気・見た目の印象で人を惹きつけるタイプです。",
      "絵柄、配色、装飾、空気感、サムネイル。細かい言葉よりも、まず視覚で「好き」と思わせる力があります。",
      "あなたの作品は、内容だけでなく、見た瞬間のかわいさ・美しさ・雰囲気づくりで伸びやすいです。",
      "漫画制作では、仕上げ、表紙、投稿画像、キャラクターデザインにも向いています。"
    ],
    step: "ひとつの作品に使う色を、まず3色だけ決めてみましょう。色の統一感が出ると、あなたの世界観は一気に強くなります。"
  },
  "五芒星（ペンタグラム）を操る影の勇者": {
    subtitle: "五つの力を秘めし、創作界の隠れチート枠",
    body: [
      "おめでとうございます。",
      "あなたは、かなりレアなバランス型の創作者です。",
      "クリエイティブ力、メディアへの情報力、漫画の知識、エモーション力、作り上げる力と継続力。",
      "この五つの力が高い水準でまとまっており、「何を作るか」「どう見せるか」「誰に届けるか」「どう完成させるか」までを、ひとつの流れとして考えられるタイプです。",
      "派手に前へ出る主人公というより、物語の裏側で全体を動かす影の勇者。",
      "企画、構成、制作、仕上げ、発信まで、複数の力をつなげて作品にできる可能性があります。"
    ],
    step: "小さな作品でもいいので、「物語」「見た目」「届け方」「完成までの手順」をセットで考えてみましょう。あなたは、ひとつの役割だけを担うより、物語全体を導くことで真価を発揮します。AIや制作ツールを使うことで、あなたの中にある複数の力をつなげやすくなります。"
  },
  "呼ぶ声に応える覚醒者": {
  ...
  "世界を夢見る旅立ちの勇者": {
    ...
    body: [
      "あなたは、これから創作の世界へ踏み出す始まりのタイプです。",
      "まだ道具も知識もそろっていないかもしれません。でも、知らない世界を見てみたい、自分にも何か作れるかもしれない、そんな気持ちが旅の始まりになります。",
      "このタイプに大事なのは、いきなり大作を目指さないこと。小さな1ページ、小さな1キャラ、小さな1投稿からで十分です。"
    ],
    step: "まずは「自分が好きな世界」をひとつ選んで、そこに登場しそうなキャラを考えてみましょう。勇者の旅は、最初の名前を決めるところから始まります。"
  }
};
